...
public class Javafinder {
  ...
  public static List<File> findJavaFiles(Path directory, String... exclude){
    ...
    return findFiles(directory.toFile(), JAVA_MATCHER, exclude);
  }
  ...
  public static List<File> findJavaClasses(Path directory, String... exclude){
    ...
    return findFiles(directory.toFile(), CLASS_MATCHER, exclude);
  }
   ...
   * @return the list of files matching a given extension.
   */
  private static List<File> findFiles(File directory, final PathMatcher matcher, String... skipHints){
   ...
   */
  private static List<File> walkDirectory(final File location, final PathMatcher matcher, final String... keywords) throws IOException {
