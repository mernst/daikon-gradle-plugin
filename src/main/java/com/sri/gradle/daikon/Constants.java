...
public class Constants {
  ...
  public static final String DAIKON_EVIDENCE_TASK_DESCRIPTION =
      "Produces an evidence artifact containing the specific details of the Daikon execution.";
  ...
  public static final OutputStream QUIET_OUTPUT =
      new OutputStream() {
        @Override
  ...
  public static final String DRIVER_EXIST =
      "Test driver already exists. Skipping " + NEW_LINE + "'generateTestDriverCode' task";
  ...
  public static final String DAIKON_IN_CLASSPATH = "Good. Daikon is in your CLASSPATH!";
